        ...
        if (version == 2) {
            ...
            drawnObjects.forEach(function (object) {
                ...
                if (object.obj instanceof Line) {
                    ...
                    for (var i = 0; i < object.obj.text.length; i++) {
                        // draw each line of text
                        ctx.fillText(object.obj.text[i], object.obj.bo.a.x * zoom, ((object.obj.bo.a.y * zoom) + (fontsize_1 * (i + 1))));
                    }
                }
            });
            // draw current line
            ...
            if (carretVisible && carretOn) {
                ...
                ctx.strokeStyle = "black";
                ctx.beginPath();
                var carretX = ctx.measureText(newText.text[carretLinePosition].substring(0, carretCharPosition)).width + 2;
